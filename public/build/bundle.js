...
var _Zones = __webpack_require__(29);

var _Zones2 = _interopRequireDefault(_Zones);

var _Comments = __webpack_require__(31);
...
var _Zone = __webpack_require__(30);
...
var Zone = function Zone(props) {
    ...
    var zipCode = props.zone.zipCodes[0];
    return _react2.default.createElement(
        'div',
...
var Comments = function (_Component) {
    ...
    function Comments() {
        ...
        _this.state = {
            ...
            comments: [{ body: 'comment 1', username: 'dtrump', timestamp: '10:30' }, { body: 'comment 2', username: 'hclinton', timestamp: '1:15' }, { body: 'comment 3', username: 'gjohnson', timestamp: '7:30' }]
        };
        return _this;
    }
    ...
    _createClass(Comments, [{
        ...
        value: function submitComment() {
            ...
            if (updatedComment.username !== '' && updatedComment.body !== '') {
                var updatedComments = Object.assign([], this.state.comments);
        ...
        value: function clearInputs() {
            ...
            usernameInput.value = '';
            var commentInput = document.getElementById('body');
            commentInput.value = '';
        }
    }, {
        key: 'updateUsername',
        ...
        value: function render() {
            var comments = this.state.comments.map(function (comment, id) {
                return _react2.default.createElement(
                    'li',
                    { key: id },
                    _react2.default.createElement(_Comment2.default, { userComment: comment })
                );
            });
            return _react2.default.createElement(
                'div',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: 'Username', onChange: this.updateUsername.bind(this), id: 'username' }),
                    _react2.default.createElement('br', null),
                    _react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: 'Comment', onChange: this.updateBody.bind(this), id: 'body' }),
                    _react2.default.createElement('br', null),
                    _react2.default.createElement(
                        'button',
...
var Comment = function Comment(params) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'p',
            { style: _styles2.default.comment.commentBody },
            params.userComment.body
        ),
        _react2.default.createElement(
            'span',
            { style: _styles2.default.comment.commentUsername },
            params.userComment.username
        ),
        _react2.default.createElement(
            'span',
            { style: _styles2.default.comment.commentSeparator },
            '|'
        ),
        _react2.default.createElement(
            'span',
            { style: _styles2.default.comment.commentTimestamp },
            params.userComment.timestamp
        ),
